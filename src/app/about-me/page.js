    ...
    return (
        <div className="flex flex-col min-h-screen text-white bg-[#2D5A76]">
            ...
            <main className="flex flex-col">
                {/* Hero-Section */}
                <section
                    className="flex flex-col lg:flex-row items-center justify-center h-auto lg:h-screen px-6 sm:px-12 mt-22">
                    <div
                        className="w-full lg:w-1/2 text-lg sm:text-xl md:text-2xl lg:text-3xl mb-8 lg:mb-0 lg:ml-20">
                        Ich bin 18 Jahre alt. An der Kantonsschule Hottingen bin
                        ich ein Schüler. In der Ausbildung bin ich als
                        Informatiker
